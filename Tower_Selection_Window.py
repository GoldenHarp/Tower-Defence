...
Tower_Selection_img = pygame.image.load("Sprites\\Tower_Selection_img.bmp")
Tower_Selection_img = pygame.transform.scale(Tower_Selection_img,(200,300))
Archer_Tower_img = pygame.image.load("Sprites\\Archer_Tower.bmp")
Archer_Tower_img = pygame.transform.scale(Archer_Tower_img,(30,30))
Freeze_Tower_img = pygame.image.load("Sprites\\Freeze_Tower.bmp")
